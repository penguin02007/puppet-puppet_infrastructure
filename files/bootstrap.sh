...
/opt/puppet/bin/puppet apply --debug -trace --verbose --modulepath=/etc/puppetlabs/code/modules /etc/puppetlabs/code/modules/puppet_infrasturcture/examples/init.pp
